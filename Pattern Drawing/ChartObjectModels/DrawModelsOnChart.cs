...
namespace cAlgo.ChartObjectModels
{
    public static class DrawModelsOnChart
    {
        public static ChartObject DrawModel(this Chart chart, IChartObjectModel model)
        {
            ...
            switch (model.ObjectType)
            {
                case ChartObjectType.TrendLine:
                    ...
                    var chartTrendLine = chart.DrawTrendLine(trendLineModel.Name, trendLineModel.Time1,
                        trendLineModel.Y1, trendLineModel.Time2, trendLineModel.Y2,
                        Color.FromHex(trendLineModel.ColorHex), trendLineModel.Thickness, trendLineModel.LineStyle);
                ...
                case ChartObjectType.Text:
                    ...
                    var chartText = chart.DrawText(textModel.Name, textModel.Text, textModel.Time, textModel.Y,
                        Color.FromHex(textModel.ColorHex));
                ...
                case ChartObjectType.Triangle:
                    ...
                    chartObject = chart.DrawTriangle(triangleModel.Name, triangleModel.Time1, triangleModel.Y1,
                        triangleModel.Time2, triangleModel.Y2, triangleModel.Time3, triangleModel.Y3,
                        Color.FromHex(triangleModel.ColorHex));
                ...
                case ChartObjectType.Rectangle:
                    ...
                    chartObject = chart.DrawRectangle(rectangleModel.Name, rectangleModel.Time1, rectangleModel.Y1,
                        rectangleModel.Time2, rectangleModel.Y2, Color.FromHex(rectangleModel.ColorHex));
                ...
                case ChartObjectType.VerticalLine:
                    ...
                    chartObject = chart.DrawVerticalLine(verticalLineModel.Name, verticalLineModel.Time,
                        Color.FromHex(verticalLineModel.ColorHex), verticalLineModel.Thickness,
                        verticalLineModel.LineStyle);

                    break;

                default:
                    throw new InvalidOperationException($"Not supported object type {model.ObjectType}");
            }

            if (chartObject != null)
            {
                if (chartObject is ChartShape chartShape && model is ChartShapeModel chartShapeModel)
                {
        ...
        {
            foreach (var model in models) chart.DrawModel(model);
        }
    }
}