    ...
    public static class ChartObjectToModel
    {
        public static IChartObjectModel GetObjectModel(this ChartObject chartObject)
        {
            ...
            switch (chartObject.ObjectType)
            {
                ...
                default:
                    throw new InvalidOperationException($"Not supported object type {chartObject.ObjectType}");
            }

            if (chartObjectModel != null)
            {
                if (chartObject is ChartShape chartShape && chartObjectModel is ChartShapeModel chartShapeModel)
                {
