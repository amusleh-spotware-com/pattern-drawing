...
namespace cAlgo.Patterns
{
    ...
    {
        public ElliottCorrectionWavePattern(PatternConfig config, ElliottWaveDegree degree) : base("EW ABC", config, 3,
            degree)
        {
        }
        ...
        private void DrawLabels(Chart chart, ChartTrendLine firstLine, ChartTrendLine secondLine, ChartTrendLine thirdLine, long id)
        {
            switch (Degree)
            {
                case ElliottWaveDegree.SuperMellennium:
                    ...
                    DrawLabelText(chart, "((C))", thirdLine.Time2, thirdLine.Y2, id, isBold: true);
                    break;
                ...
                case ElliottWaveDegree.Primary:
                    ...
                    DrawLabelText(chart, "((C))", thirdLine.Time2, thirdLine.Y2, id, fontSize: 10);
                    break;
                ...
                case ElliottWaveDegree.Micro:
                    ...
                    DrawLabelText(chart, "((C))", thirdLine.Time2, thirdLine.Y2, id, fontSize: 7);
                    break;
