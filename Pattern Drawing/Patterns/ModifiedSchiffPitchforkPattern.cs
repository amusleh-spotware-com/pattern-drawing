...
namespace cAlgo.Patterns
{
    ...
    {
        private readonly ModifiedSchiffPitchforkPatternSettings _settings;

        private ChartTrendLine _handleLine;
        private ChartTrendLine _medianLine;
        private ChartTrendLine _schiffLine;

        public ModifiedSchiffPitchforkPattern(PatternConfig config, ModifiedSchiffPitchforkPatternSettings settings) :
            base("Modified Schiff Pitchfork", config)
        {
            _settings = settings;
        }
