...
namespace cAlgo.Patterns
{
    public class TrianglePattern : PatternBase
    {
        ...
        protected override void OnMouseDown(ChartMouseEventArgs obj)
        {
            ...
            _triangle = obj.Chart.DrawTriangle(name, obj.TimeValue, obj.YValue, obj.TimeValue, obj.YValue, obj.TimeValue,
                obj.YValue, Color);
        ...
        protected override void DrawLabels(Chart chart)
        {
            ...
            DrawLabels(chart, _triangle, Id);
        }

        private void DrawLabels(Chart chart, ChartTriangle triangle, long id)
        {
            DrawLabelText(chart, "A", triangle.Time1, triangle.Y1, id);
            DrawLabelText(chart, "B", triangle.Time2, triangle.Y2, id);
            DrawLabelText(chart, "C", triangle.Time3, triangle.Y3, id);
        }
        ...
        protected override ChartObject[] GetFrontObjects() => new ChartObject[] {_triangle};
    }
}