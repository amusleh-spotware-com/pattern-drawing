...
namespace cAlgo.Patterns
{
    public class GannBoxPattern : PatternBase
    {
        ...
        protected override void DrawLabels(Chart chart)
        {
            ...
            DrawLabels(chart, _rectangle, _horizontalTrendLines, _verticalTrendLines, Id);
        }

        private void DrawLabels(Chart chart, ChartRectangle rectangle, ChartTrendLine[] horizontalLines,
            ChartTrendLine[] verticalLines, long id)
        {
            var timeDistance = -TimeSpan.FromHours(chart.Bars.GetTimeDiff().TotalHours * 2);

            DrawLabelText(chart, "0", rectangle.Time1, rectangle.Y1, id, objectNameKey: "0.0", fontSize: 10);
            DrawLabelText(chart, "1", rectangle.Time1, rectangle.Y2, id, objectNameKey: "1.1", fontSize: 10);

            DrawLabelText(chart, "0", rectangle.Time1.Add(timeDistance), rectangle.Y1, id, objectNameKey: "0.2", fontSize: 10);
            DrawLabelText(chart, "1", rectangle.Time2.Add(timeDistance), rectangle.Y1, id, objectNameKey: "1.3", fontSize: 10);

            DrawLabelText(chart, "0", rectangle.Time2, rectangle.Y1, id, objectNameKey: "0.4", fontSize: 10);
            DrawLabelText(chart, "1", rectangle.Time2, rectangle.Y2, id, objectNameKey: "1.5", fontSize: 10);

            DrawLabelText(chart, "0", rectangle.Time1.Add(timeDistance), rectangle.Y2, id, objectNameKey: "0.6", fontSize: 10);
            DrawLabelText(chart, "1", rectangle.Time2.Add(timeDistance), rectangle.Y2, id, objectNameKey: "1.7", fontSize: 10);
            ...
            for (var i = 0; i < minLength; i++)
            {
                ...
                {
                    case 0:
                        DrawLabelText(chart, "0.25", horizontalLine.Time1, horizontalLine.Y1, id,
                            objectNameKey: "Horizontal1.0", fontSize: 10);
                        DrawLabelText(chart, "0.25", horizontalLine.Time2, horizontalLine.Y2, id,
                            objectNameKey: "Horizontal1.1", fontSize: 10);

                        DrawLabelText(chart, "0.25", verticalLine.Time1, verticalLine.Y1, id, objectNameKey: "Vertical1.0",
                            fontSize: 10);
                        DrawLabelText(chart, "0.25", verticalLine.Time2, verticalLine.Y2, id, objectNameKey: "Vertical1.1",
                            fontSize: 10);
                        break;

                    case 1:
                        DrawLabelText(chart, "0.382", horizontalLine.Time1, horizontalLine.Y1, id,
                            objectNameKey: "Horizontal2.0", fontSize: 10);
                        DrawLabelText(chart, "0.382", horizontalLine.Time2, horizontalLine.Y2, id,
                            objectNameKey: "Horizontal2.1", fontSize: 10);

                        DrawLabelText(chart, "0.382", verticalLine.Time1, verticalLine.Y1, id, objectNameKey: "Vertical2.0",
                            fontSize: 10);
                        DrawLabelText(chart, "0.382", verticalLine.Time2, verticalLine.Y2, id, objectNameKey: "Vertical2.1",
                            fontSize: 10);
                        break;

                    case 2:
                        DrawLabelText(chart, "0.5", horizontalLine.Time1, horizontalLine.Y1, id,
                            objectNameKey: "Horizontal3.0", fontSize: 10);
                        DrawLabelText(chart, "0.5", horizontalLine.Time2, horizontalLine.Y2, id,
                            objectNameKey: "Horizontal3.1", fontSize: 10);

                        DrawLabelText(chart, "0.5", verticalLine.Time1, verticalLine.Y1, id, objectNameKey: "Vertical3.0",
                            fontSize: 10);
                        DrawLabelText(chart, "0.5", verticalLine.Time2, verticalLine.Y2, id, objectNameKey: "Vertical3.1",
                            fontSize: 10);
                        break;

                    case 3:
                        DrawLabelText(chart, "0.618", horizontalLine.Time1, horizontalLine.Y1, id,
                            objectNameKey: "Horizontal4.0", fontSize: 10);
                        DrawLabelText(chart, "0.618", horizontalLine.Time2, horizontalLine.Y2, id,
                            objectNameKey: "Horizontal4.1", fontSize: 10);

                        DrawLabelText(chart, "0.618", verticalLine.Time1, verticalLine.Y1, id, objectNameKey: "Vertical4.0",
                            fontSize: 10);
                        DrawLabelText(chart, "0.618", verticalLine.Time2, verticalLine.Y2, id, objectNameKey: "Vertical4.1",
                            fontSize: 10);
                        break;

                    case 4:
                        DrawLabelText(chart, "0.75", horizontalLine.Time1, horizontalLine.Y1, id,
                            objectNameKey: "Horizontal5.0", fontSize: 10);
                        DrawLabelText(chart, "0.75", horizontalLine.Time2, horizontalLine.Y2, id,
                            objectNameKey: "Horizontal5.1", fontSize: 10);

                        DrawLabelText(chart, "0.75", verticalLine.Time1, verticalLine.Y1, id, objectNameKey: "Vertical5.0",
                            fontSize: 10);
                        DrawLabelText(chart, "0.75", verticalLine.Time2, verticalLine.Y2, id, objectNameKey: "Vertical5.1",
                            fontSize: 10);
                        break;
                }
            }
            ...
            ChartObject[] patternObjects)
        {
            ...
            if (labels.Length == 0)
            {
                DrawLabels(chart, rectangle, horizontalLines, verticalLines, id);
            ...
            foreach (var label in labels)
            {
                ...
                {
                    case "Horizontal1.0":
                        chartTrendLine = horizontalLines.First(iLine =>
                            iLine.Name.EndsWith("HorizontalLine1", StringComparison.OrdinalIgnoreCase));
                    ...
                    case "Horizontal2.0":
                        chartTrendLine = horizontalLines.First(iLine =>
                            iLine.Name.EndsWith("HorizontalLine2", StringComparison.OrdinalIgnoreCase));
                    ...
                    case "Horizontal3.0":
                        chartTrendLine = horizontalLines.First(iLine =>
                            iLine.Name.EndsWith("HorizontalLine3", StringComparison.OrdinalIgnoreCase));
                    ...
                    case "Horizontal4.0":
                        chartTrendLine = horizontalLines.First(iLine =>
                            iLine.Name.EndsWith("HorizontalLine4", StringComparison.OrdinalIgnoreCase));
                    ...
                    case "Horizontal5.0":
                        chartTrendLine = horizontalLines.First(iLine =>
                            iLine.Name.EndsWith("HorizontalLine5", StringComparison.OrdinalIgnoreCase));
                    ...
                    case "Vertical1.0":
                        chartTrendLine = verticalLines.First(iLine =>
                            iLine.Name.EndsWith("VerticalLine1", StringComparison.OrdinalIgnoreCase));
                    ...
                    case "Vertical2.0":
                        chartTrendLine = verticalLines.First(iLine =>
                            iLine.Name.EndsWith("VerticalLine2", StringComparison.OrdinalIgnoreCase));
                    ...
                    case "Vertical3.0":
                        chartTrendLine = verticalLines.First(iLine =>
                            iLine.Name.EndsWith("VerticalLine3", StringComparison.OrdinalIgnoreCase));
                    ...
                    case "Vertical4.0":
                        chartTrendLine = verticalLines.First(iLine =>
                            iLine.Name.EndsWith("VerticalLine4", StringComparison.OrdinalIgnoreCase));
                    ...
                    case "Vertical5.0":
                        chartTrendLine = verticalLines.First(iLine =>
                            iLine.Name.EndsWith("VerticalLine5", StringComparison.OrdinalIgnoreCase));
