...
namespace cAlgo.Patterns
{
    ...
    {
        public ElliottTriangleWavePattern(PatternConfig config, ElliottWaveDegree degree) : base("EW ABCDE", config, 5,
            degree)
        {
        }
            ...
            ChartTrendLine fourthLine, ChartTrendLine fifthLine, long id)
        {
            switch (Degree)
            {
                case ElliottWaveDegree.SuperMellennium:
                    ...
                    DrawLabelText(chart, "((A))", secondLine.Time1, secondLine.Y1, id, isBold: true);
                    DrawLabelText(chart, "((B))", thirdLine.Time1, thirdLine.Y1, id, isBold: true);
                    DrawLabelText(chart, "((C))", fourthLine.Time1, fourthLine.Y1, id, isBold: true);
                    DrawLabelText(chart, "((D))", fifthLine.Time1, fifthLine.Y1, id, isBold: true);
                    DrawLabelText(chart, "((E))", fifthLine.Time2, fifthLine.Y2, id, isBold: true);
                    break;
                ...
                case ElliottWaveDegree.Primary:
                    ...
                    DrawLabelText(chart, "((A))", secondLine.Time1, secondLine.Y1, id, fontSize: 10);
                    DrawLabelText(chart, "((B))", thirdLine.Time1, thirdLine.Y1, id, fontSize: 10);
                    DrawLabelText(chart, "((C))", fourthLine.Time1, fourthLine.Y1, id, fontSize: 10);
                    DrawLabelText(chart, "((D))", fifthLine.Time1, fifthLine.Y1, id, fontSize: 10);
                    DrawLabelText(chart, "((E))", fifthLine.Time2, fifthLine.Y2, id, fontSize: 10);
                    break;
                ...
                case ElliottWaveDegree.Micro:
                    ...
                    DrawLabelText(chart, "((A))", secondLine.Time1, secondLine.Y1, id, fontSize: 7);
                    DrawLabelText(chart, "((B))", thirdLine.Time1, thirdLine.Y1, id, fontSize: 7);
                    DrawLabelText(chart, "((C))", fourthLine.Time1, fourthLine.Y1, id, fontSize: 7);
                    DrawLabelText(chart, "((D))", fifthLine.Time1, fifthLine.Y1, id, fontSize: 7);
                    DrawLabelText(chart, "((E))", fifthLine.Time2, fifthLine.Y2, id, fontSize: 7);
                    break;
