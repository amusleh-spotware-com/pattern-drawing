...
namespace cAlgo.Patterns
{
    public class HeadAndShouldersPattern : PatternBase
    {
        ...
        protected override void DrawLabels(Chart chart)
        {
            ...
            DrawLabels(chart, _leftTriangle, _headTriangle, _rightTriangle, Id);
        }

        private void DrawLabels(Chart chart, ChartTriangle leftTriangle, ChartTriangle headTriangle, ChartTriangle rightTriangle,
            long id)
        {
            DrawLabelText(chart, "Left", leftTriangle.Time2, leftTriangle.Y2, id);
            DrawLabelText(chart, "Head", headTriangle.Time2, headTriangle.Y2, id);
            DrawLabelText(chart, "Right", rightTriangle.Time2, rightTriangle.Y2, id);
        }
            ...
            ChartObject[] patternObjects)
        {
            ...
            if (labels.Length == 0)
            {
                DrawLabels(chart, leftTriangle, headTriangle, rightTriangle, id);
